...
const Financeiro: React.FC = () => {
  ...
  // REALTIME ATIVADO: Escuta mudanças em reservas e logs para atualizar o financeiro na hora
  useEffect(() => {
    refreshData();
  ...
  // FILTRO ATUALIZADO: Apenas confirmadas/check-in que estejam PAGAS
